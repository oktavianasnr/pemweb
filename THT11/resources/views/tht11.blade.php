...
<head>
    ...
    <link rel="stylesheet" href="tht11.css">
...
<body>
    ...
    <div class="container">
        <div class="gambar">
            <img src="https://img.freepik.com/premium-photo/rendang-traditional-food-from-padang-indonesia-made-from-beef-various-kind-herbs-very-popular-during-eid-mubarak_511235-2309.jpg" alt="Rendang"width="300px" height="250">
            <h3>Rendang</h3>
        </div>
        <div class="gambar">
    ...
    <div class = "grid-container">
        ...
        <div class = "menu"><a href="/indonesia">Indonesia</a></div>
    ...
    <div class="layout">
        <main class="form">
            ...
            <form action="{{ route('handle.form') }}" method="POST" id="form">
                @csrf
            ...
            <h3><div id="hasilInput">{{ $hasilInput }}</div></h3>
        </main>
    ...
    <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
        <form action="{{ route('comments.store') }}" method="POST" id="komentarForm">
            @csrf
            <h2>Kirim Komentar</h2>
            <label for="komentar">Komentar : </label>
            <textarea id="komentar" name="comment" rows="4" required placeholder="Tulis komentar Anda di sini..."></textarea>
            <br>
            <button type="submit" onclick="submitKomentar()">Submit</button>
        </form>
    </nav>
